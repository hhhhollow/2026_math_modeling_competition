...
\noindent
\textbf{问题背景}：以某污水处理厂 10 台并联过滤设备（A1--A10）2024 年 4 月至 2026 年 4 月共两年的小时级透水率数据为研究对象，结合 94 次维护记录，依次完成（1）数据特征指标提取，（2）当前固定维护规律下的寿命预测，（3）最小年化成本的最优维护策略求解，（4）成本参数 $\pm 30\%$ 敏感性分析。
